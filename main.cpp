...
should be left unchanged and the function should print a message indicating "Debit amount exceeded account
 balance." Member function getBalance should return the current balance. Create a
...
int main ()
{
    ...
    cout << "Account A balance is: " << a.getBalance() << endl;
    cout << "Account B balance is: " << b.getBalance() << endl;
}
